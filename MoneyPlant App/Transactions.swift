...
var transactions: [Transactions] = [
    ...
    Transactions(symbol: UIImage(systemName: "bag.fill")!, name: "Dress",
                 amount: 1000.00, category: "Shopping"),
    Transactions(symbol: UIImage(systemName: "fuelpump.fill")!, name: "Car Petrol",
                 amount: 2500.00, category: "Fuel"),
    Transactions(symbol: UIImage(systemName: "car.fill")!, name: "Car",
