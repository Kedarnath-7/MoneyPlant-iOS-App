    ...
    @IBAction func unwindToBudgetsViewController(segue: UIStoryboardSegue) {
        ...
        if let totalBudget = sourceVC.totalBudget {
            ...
            if let existingBudget = currentMonthBudget {
                ...
                // Automatically distribute the budget across weeks
                PersistenceController.shared.distributeBudgetAcrossWeeks(for: existingBudget)
            } else {
                ...
                // Automatically distribute the budget across weeks
                if let addedBudget = addedTotalBudget { PersistenceController.shared.distributeBudgetAcrossWeeks(for: addedBudget)
                }
